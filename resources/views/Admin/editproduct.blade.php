              ...
              <ul>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('Product_name',$product->Product_name,['class'=>'form-control','id'=>'exampleInputEmail1','placehoder'=>'Enter product'])}}
                  </div>
                  <div class="form-group">
                    {{Form::label('','Product price',['for'=> 'exampleInputEmail1'])}}
                    {{Form::text('Product_price',$product->Product_price,['class'=>'form-control','id'=>'exampleInputEmail1','placehoder'=>'Enter product'])}}
                  </div>
                  <div class="form-group">
